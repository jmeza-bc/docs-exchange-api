...
```python
# Simple Python-based WebSocket client
...
Currently available WebSocket endpoints are:

| Environment | URI                                              |
| ----------- | ------------------------------------------------ |
| production  | `wss://ws.blockchain.info/mercury-gateway/v1/ws` |

In order to connect you, add the following headers to the connection request:

| Environment | Headers                                   |
| ----------- | ----------------------------------------- |
| production  | `Origin: https://exchange.blockchain.com` |
